...
def structural(cur):
    ...
    expected = {
        ...
        "films": 5265, "people": 11144, "nomination_films": 10879,
...
def imdb_enrichment(cur):
    ...
    """).fetchall()
    check("people coverage: persons 10836/10100 id/6785 birth/4087 death; companies 308/71/0/0",
          people_cov == [("company", 308, 71, 0, 0), ("person", 10836, 10100, 6785, 4087)],
          people_cov)
